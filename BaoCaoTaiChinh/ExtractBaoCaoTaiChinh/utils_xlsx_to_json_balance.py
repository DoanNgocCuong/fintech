"""
Module để chuyển đổi Excel (.xlsx) sang JSON cho Bảng Cân Đối Kế Toán.
...
def create_json_result(
    ...
    của Bảng Cân Đối Kế Toán để giữ backward compatibility.
    ...
    return _create_json_result(
        ...
        json_template_func=_get_balance_sheet_json_template,
        output_json_file=output_json_file,
        replace_null_with=replace_null_with,
        sanitize_nan=True  # Balance sheet cần sanitize NaN
    )
