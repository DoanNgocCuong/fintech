...
from main_KetQuaHoatDongKinhDoanh import _get_income_statement_json_template
...
def create_json_result(
    ...
    json_result = _get_income_statement_json_template(replace_null_with=replace_null_with)
