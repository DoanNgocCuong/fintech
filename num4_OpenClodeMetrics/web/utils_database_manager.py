"""
Database utilities for open_code_metrics table.
...
# Table name - có thể thay đổi tùy theo database schema thực tế
TABLE_NAME = 'open_code_metrics'
...
def get_stats() -> Dict[str, Any]:
    ...
    try:
        ...
        # Total companies
        cursor.execute(f'SELECT COUNT(DISTINCT company_name) FROM "{TABLE_NAME}"')
